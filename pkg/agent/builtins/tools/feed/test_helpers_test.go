...
func (m *mockFeedTestAgent) Run(ctx context.Context, input *domain.State) (*domain.State, error) { return input, nil }
func (m *mockFeedTestAgent) RunAsync(ctx context.Context, input *domain.State) (<-chan domain.Event, error) { return nil, nil }
...
func (m *mockFeedTestAgent) AfterRun(ctx context.Context, state *domain.State, result *domain.State, err error) error { return nil }
