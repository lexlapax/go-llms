...
// ABOUTME: Example demonstrating structured output validation with type coercion
// ABOUTME: Shows how the schema validation handles flexible input types and converts them
